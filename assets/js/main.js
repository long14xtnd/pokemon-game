...
Vue.createApp({
  ...
  methods: {
    ...
    handleSelectCard(card) {
      // console.log(card)
      /**
       * Thuật toán ở đây là khi người dùng nhấn vào thẻ bất kì thì thẻ sẽ được lưu vào trong selectCard
       * tiếp theo ta đi kiểm tra xem nếu như bên trong selectCard đã có 2 thẻ thì kiểm tra xem 2 thẻ đó có giống nhau hay không(dựa vào id)
       * nếu như giống nhau thì đẩy 2 thẻ đó vào mảng tên là pairedCard còn không thì reset lại cho selectCard = []
       *
       */
